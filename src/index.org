...
* Hi and welcome to my blog :)
  ...
  - personal stuff: Linux on "unusual" devices, homemade mini laptops,
    blinky LED wearable stuff, terminal apps no one needs, custom PCBs...
...
** Other places where you can find me
  ...
  *Github for this blog:* [[https://github.com/bitshiftcrazy][miss.molerat]]

  I upload code I mention or post here there, (most of) the code for this website is also there.
